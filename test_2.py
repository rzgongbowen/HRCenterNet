...
def main():
    ...
    # log_dir = '/mnt/sda/gbw/HRCenterNet_/weights/xxshanzi/best.pth.tar'
    ...
    out_path = '/mnt/sda/gbw/HRCenterNet_/xxs_input_all_5/'
    ...
    test_path = '/mnt/sda/gbw/HRCenterNet_/xxs_input_all/0'
